...
function Profile() {
  ...
  const handlePageSelection = (e) => {
    ...
    if (e.target.textContent === "게시물") setPageSelection("posts");
    else if (e.target.textContent === "저장됨") setPageSelection("saved");
    else if (e.target.textContent === "태그됨") setPageSelection("tagged");
  };
      ...
      <Layout>
        <Wrapper>
          <Container>
            ...
            <SelectionBox>
              <div status={pageSelection}>
                <SelectionItem onClick={handlePageSelection}>
                  게시물
                </SelectionItem>
              </div>
              <div status={pageSelection}>
            ...
            {(pageSelection === SelectionStatus.POSTS && (
              <PostBox>
                <FeedBox style={{ margin: "58px 0 0 0" }}>
                  <div>
                    <FeedImg />
                  </div>
                  <div>
