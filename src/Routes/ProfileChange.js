                ...
                <UserProfileBox>
                  ...
                  <div style={{ flexGrow: "1", lineHeight: "25px" }}>
                    ...
                    <div style={{ lineHeight: "0px" }}>
                      <ChangeImgButton>프로필 사진 바꾸기</ChangeImgButton>
                    </div>
                  </div>
                </UserProfileBox>
                <UserChangeBox>
                  ...
                  <UserChangeSubBox style={{ height: "120px" }}>
                    ...
                    <ChangeInputBox>
                      ...
                      >
                        <ChangeDesc
                          style={{ height: "48px", lineHeight: "120%" }}
                        >
                          사람들이 이름, 별명 또는 비즈니스 이름 등 회원님의
                          알려진 이름을 사용하여 회원님의 계정을 찾을 수 있도록
                          도와주세요.
                        </ChangeDesc>
                        <ChangeDesc
                          style={{ height: "16px", lineHeight: "120%" }}
                        >
                    ...
                    <ChangeInputBox>
                      ...
                      >
                        <ChangeDesc
                          style={{ height: "48px", lineHeight: "120%" }}
                        >
                          대부분의 경우 이후 14일 동안 사용자 이름을 다시{" "}
                          {userId}(으)로 변경할 수 있습니다. 더 알아보기
                        </ChangeDesc>
                      </div>
                    </ChangeInputBox>
                  </UserChangeSubBox>
                  ...
                  >
                    ...
                    <ChangeInputBox>
                      <ChangeInput value={userSex} />
                    </ChangeInputBox>
                  </UserChangeSubBox>

                  <UserChangeSubBox style={{ height: "54px" }}>
                    <ChangeClass style={{ paddingLeft: "2px" }}>
                      <label
                        style={{
                          position: "absolute",
                          top: "-15px",
                    ...
                    <div style={{ display: "flex", flexGrow: "1" }}>
                      ...
                      >
                        팔로우할 만한 비슷한 계정을 추천할 때 회원님의 계정을
                        포함합니다.[?]
                      </div>
                    </div>
                  </UserChangeSubBox>
